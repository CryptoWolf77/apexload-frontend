...
class AppLocalizations {
  ...
  static const _values = <String, Map<String, String>>{
    'en': {
      ...
      'downloadJobCreated': 'Demo download job created.',
    ...
    'ar': {
      ...
      'legalShort': 'قم بتنزيل المحتوى الذي تملكه أو لديك إذن باستخدامه فقط.',
      'legalFull':
          'هذا التطبيق مخصص فقط لتنزيل المحتوى الذي تملكه، أو لديك إذن لاستخدامه، أو المحتوى المسموح بتنزيله بشكل عام. أنت مسؤول عن احترام حقوق النشر وشروط المنصات.',
      'supportedPlatforms': 'المنصات المدعومة',
      'recentDownloads': 'آخر التنزيلات',
      'viewAll': 'عرض الكل',
      ...
      'noWatermarkDownloads': 'تنزيلات بدون علامة مائية',
      'noWatermarkWhenAvailable': 'بدون علامة مائية عند توفرها',
      'homeUpgradeCopy':
          'احصل على بريميوم لتنزيل بجودة FHD و 4K عند توفرها، وبدون إعلانات، والدفعات، والمحرر السريع، وتبديل الصوت، و',
      'fhd4kDownloads': 'تنزيل بجودة FHD و 4K عند توفرها',
      'fhd4kDownloadsWhenAvailable': 'نزّل بجودة FHD و 4K عند توفرها.',
      ...
      'premiumActiveButton': 'بريميوم مفعل',
      'termsPrivacyPlaceholder':
      ...
      'premiumFeatureSummary':
          'افتح جودة FHD و 4K عند توفرها، وبدون علامة مائية عند توفرها، والمحرر السريع، واستخراج الصوت، وتنزيل الدفعات.',
      'downloadProgress': 'تقدم التنزيل',
      'openLibrary': 'فتح المكتبة',
      'downloadAnother': 'تنزيل رابط آخر',
      'cancel': 'إلغاء',
      'platform': 'المنصة',
      'speed': 'السرعة',
      ...
      'dailyLimitReachedMessage':
          'لقد وصلت إلى الحد اليومي المجاني. قم بالترقية إلى بريميوم لتنزيلات غير محدودة.',
      'freeDownloadsLeft': 'التنزيلات المجانية المتبقية اليوم: {count}/5',
      ...
      'fhd4kPremiumTitle': 'تنزيلات FHD و 4K ميزة بريميوم.',
      'fhd4kPremiumMessage': 'قم بالترقية للتنزيل بجودة أعلى عند توفرها.',
      'batchPremiumTitle': 'تنزيل الدفعات ميزة بريميوم.',
      'batchPremiumMessage': 'قم بالترقية لتنزيل عدة روابط معاً.',
      'audioExtractionPremiumTitle': 'استخراج الصوت ميزة بريميوم.',
      'audioExtractionPremiumMessage':
          'قم بالترقية لاستخراج الصوت من روابط الوسائط.',
      'noWatermarkPremiumTitle': 'التنزيل بدون علامة مائية ميزة بريميوم.',
      'noWatermarkPremiumMessage':
      ...
      'noWatermarkApplied': 'يتم تطبيق بدون علامة مائية عند توفرها',
      'downloadSelected': 'تنزيل المحدد',
      'downloadSelectedItems': 'تنزيل العناصر المحددة',
      'downloadSelectedItemsCount': 'تنزيل {count} عناصر محددة',
      'selectedItemsDownloaded': 'تم تنزيل العناصر المحددة بنجاح',
      ...
      'imagePremiumMessage': 'قم بالترقية لتنزيل صيغ الصور المميزة عند توفرها.',
      'yourApexLoad': 'حساب ApexLoad الخاص بك',
      'appStatus': 'حالة التطبيق',
      'plan': 'الخطة',
      'downloadsToday': 'تنزيلات اليوم',
      ...
      'startBatchDownload': 'بدء تنزيل الدفعة',
      'ready': 'جاهز',
      ...
      'downloadLocation': 'مكان التنزيل',
      'deviceDownloadsFolder': 'مجلد التنزيلات على الجهاز',
