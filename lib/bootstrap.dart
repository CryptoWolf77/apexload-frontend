...
Future<void> bootstrapApexLoad(AppEdition edition) async {
  WidgetsFlutterBinding.ensureInitialized();
  debugPrint('ApexLoad startup: bindings initialized (${edition.name})');
  runApp(
    ProviderScope(
      overrides: [appEditionProvider.overrideWithValue(edition)],
